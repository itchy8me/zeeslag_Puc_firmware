...
//! single sample on AIN2/PE1.
//!
//! This example uses the following peripherals and I/O signals.  You must
//! review these and change as needed for your own board:
//! - ADC0 peripheral
//! - GPIO Port E peripheral (for AIN2 pin)
//! - AIN2 - PE7
//!
...
void analog_diag_enable(void){
    ...
    //
    // For this example ADC0 is used with AIN2 on port E7.
    ...
    //
    // Configure step 0 on sequence 3.  Sample channel 0 (ADC_CTL_CH2) in
...
main(void)
{
    ...
    UARTprintf("  Input Pin: AIN2/PE7\n\n");



    //
    // Sample AIN2 forever.  Display the value on the console.
    //
    while(1)
    {
    }
